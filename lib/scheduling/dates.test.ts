...
import { addDaysIso, fridaysOfMonth, wednesdaysOfMonth, weekdayDatesOfMonth, weekdayOfIso } from "./dates";
...
describe("dates", () => {
  ...
  it("weekdayDatesOfMonth encuentra los lunes de septiembre 2026 (día 1, base del reparto de Ads)", () => {
    expect(weekdayDatesOfMonth(2026, 9, 1)).toEqual(["2026-09-07", "2026-09-14", "2026-09-21", "2026-09-28"]);
  });
